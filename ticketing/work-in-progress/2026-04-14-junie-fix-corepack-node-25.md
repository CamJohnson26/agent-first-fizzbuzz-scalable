# Session: Fix Corepack Unbundling in Node.js 25

- Date: 2026-04-14
- Agent: Junie
- Task: Fix Docker build failure due to missing `corepack` in Node.js 25
...
- [x] Update `README.md` with instructions for Node.js 25+ environments.
- [x] Create RCA document for the build failure.

## Progress Summary
- Step 1: Investigated Node.js 25 changes and confirmed Corepack is no longer bundled.
...
## Unfinished Work
- None. Verification is handled by aligning with Node.js 25 official recommendations.
