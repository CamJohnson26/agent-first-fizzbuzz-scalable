# Feature: Data Exports and UI Enhancements (F121)
...
## Next Features (Todo)
- [ ] Implement export utility for multiple formats
- [ ] Add export buttons to the dashboard table
- [ ] Implement vertical/horizontal layout toggle for exports
