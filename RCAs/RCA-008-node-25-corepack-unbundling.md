...
## Action Items
1. Updated `apps/web-server/Dockerfile` to install `corepack` via `npm` before enabling it.
2. Updated `apps/web-dashboard/Dockerfile` to install `corepack` via `npm` before enabling it.
